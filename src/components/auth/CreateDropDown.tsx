...
class CreateDropDown extends React.Component {
  ...
  createDesign(item: any) {
    // @ts-expect-error ts-migrate(2339) FIXME: Property 'createDesign' does not exist on type 'Re... Remove this comment to see the full error message
    ...
    createDesign(design).then((res: any) => {
  ...
  toggleCustom() {
    // @ts-expect-error ts-migrate(2339) FIXME: Property 'custom' does not exist on type 'Readonly... Remove this comment to see the full error message
