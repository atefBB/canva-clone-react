            ...
            <li className={styles.listItem}>
              <Link to="/folder/all-designs">
                <button
                  type="button"
                  className={`${
                    location.pathname === "/folder/all-designs"
                      ? "active-route"
                      : ""
                  } btn-index`}
                >
            ...
            <li className={styles.listItem}>
              <Link to="/folder">
                <button
                  type="button"
                  className={`${
                    location.pathname === "/folder" ? "active-route" : ""
                  } btn-index`}
                >
                  <FiFolder />
            ...
            <li className={styles.listItem}>
              <Link to="/folder/likes">
                <button
                  type="button"
                  className={`${
                    location.pathname === "/folder/likes" ? "active-route" : ""
                  } btn-index`}
                >
                  <FiHeart />
            ...
            <li className={styles.listItem}>
              <Link to="/folder/uploads">
                <button
                  type="button"
                  className={`${
                    location.pathname === "/folder/uploads"
                      ? "active-route"
                      : ""
                  } btn-index`}
                >
            ...
            <li className={styles.listItem}>
              <Link to="/folder/trash">
                <button
                  type="button"
                  className={`${
                    location.pathname === "/folder/trash" ? "active-route" : ""
                  } btn-index`}
                >
                  <FiTrash2 />
        ...
        <div className={styles.main}>
          <Switch>
            ...
            <Route
              ...
              component={FolderDesignsContainer}
            />
