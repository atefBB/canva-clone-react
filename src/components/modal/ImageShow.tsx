...
const ImageShow = ({ image, user, external }: any) => {
        ...
        <div className={styles.info}>
          ...
          <div className={styles.profile}>
            <div
              ...
              style={{
                backgroundImage: `url(${
                  image.creator_thumb || "https://via.placeholder.com/320"
                })`,
              }}
            />
            {external ? (
              <p>
                ...
                <a
                  ...
                  href={`${image.creator_link}?utm_source=Gwaphics&utm_medium=referral`}
                >
                  {image.creator}
                </a>
                {" on "}
          ...
          {external ? (
            <button
              type="button"
              className="btn-blue"
              onClick={() => download(image.download)}
            >
              Download
            </button>
          ) : (
